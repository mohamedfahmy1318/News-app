...
import 'package:my_app/screens/web_view1.dart';
...
Widget itemList(dynamic artical, context) {
  try {
    return InkWell(
      ...
      onTap: () {
        navigatorTo(context, WebView1(artical:artical));
      },
    );
  } catch (erorr) {
    // ignore: avoid_print
...
Widget myList(List artical, context) {
  return ListView.separated(
    //لجعل الليسته قابله تتشد قليلا عن اخرها و اولها
    //و الاساس ظهور علامه زرقاء عن الشد من النهايه و البدايه
